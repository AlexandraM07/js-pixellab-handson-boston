...
console.warn(
  `folosind codul din html.index, introdu
  datele take su afuseaza in consola numele mic si varsta`,
);
...
scazand varsta pe care a trecut-o in obiect din anul
...
`);
console.log(object.name + ' s-a nascut in 1987.');
console.log((2022 - object.age).toString());
