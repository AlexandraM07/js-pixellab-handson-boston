...
console.warn(`
Afiseaza propozitia “Sunt xxx si acum
  invat JavaScript.” Nu folosi valoarea din arrayul de skills.
`);
...
console.warn(`
Afiseaza propozitia: “Ma numesc xxx yyy si vreau
sa invat javascript.” Foloseste notatia cu paranteze patrate.
`);
console.log(
  'Ma numesc ' +
    person.name +
...
Afiseaza propozitia “Am x prieteni: Larryson, Stevenson si Carolson.”.
  Foloseste proprietatea length si apeleaza
