...
console.warn(`
Afiseaza propozitia:
"Prietenul meu Steven Stenevson are xx ani."
...
console.warn(`
Afiseaza propozitia: "Prietenii mei sunt: Steven, Carol si Laryy.
`);
console.log(
  'Prietenii mei sunt: ' +
    person.friends.steven.name +
...
console.warn(`
Calculeaza diferenta si afiseaza propozitia: “Steven este cu xx
  ani mai mare decat Carol.” folosind proprietatile name.
`);
console.log(
  person.friends.steven.name +
    ' este cu ' +
...
console.warn(`
Afiseaza propozitia: “Prietena mea Carol Carolson are
xx ani.” folosind doar proprietatile.
`);
console.log(
  'Prietena mea ' +
    person.friends.carol.name +
