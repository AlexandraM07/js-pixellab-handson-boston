...
friends, doar daca au varsta mai mare decat 30 inclusiv.
`);
var sumBirthYears = 0;
...
console.warn(`
Folosind forEach, afiseaza suma
anilor de nastere a persoanelor care au varsta impara.
`);
var sumAge = 0;
person.friends.forEach(function (friend) {
  if (friend.age % 2 !== 0) {
...
console.warn(`
Folosind forEach, afiseaza numarul total
...
console.warn(`
Afiseaza diferenta de varsta
dintre persoana si prietenii din arrayul friends.
`);
var message = '';
person.friends.forEach(function (friend) {
  var diff = Math.abs(person.age - friend.age);
