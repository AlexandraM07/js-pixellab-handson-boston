...
console.warn(`
Calculeaza intr-o variabila
numita squareSurface aria unui patrat de 3 pe 3.
`);
...
console.warn(`
Afiseaza suprafata totala a trei dreptunghiuri
de 15 pe
31,  8 pe 9, respectiv 10 pe 5. Foloseste variabile.
`);
console.log(
...
console.warn(`
Calculeaza intr-o variabila numita anotherSquare
aria unui patrat de 8 pe 8.
`);
